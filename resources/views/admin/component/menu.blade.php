<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ $theme->logo ?? asset('images/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
            ...
            <a href="#" class="d-block">{{ Str::upper(Auth::guard('admin')->user()->name) }}</a>
            @endif
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              {{-- <li class="nav-item">
                <a href="{{route('admin.file.show')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Files hệ thống</p>
                </a>
              </li> --}}
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('user-info.index')}}" class="nav-link">
