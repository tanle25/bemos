                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <a id="lfm" data-input="thumbnail" data-preview="holder" class="btn image-header-wrapper">
                            <img id="holder" class="header-image" id="favicon" src="{{$brand->image ?? asset('images/placeholder-image.png')}}" alt="" sizes="" srcset="">
                        ...
                        <input id="thumbnail" type="hidden" name="image" class="form-control"  value="{{$brand->image ?? ''}}">
                    </div>
                </div>
