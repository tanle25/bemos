    ...
    <div class="col-md-9">
        ...
        <div class="card card-info">
            ...
            <div class="card-header">
                <h3 class="card-title">Thay đổi thông tin giấy tờ</h3>
            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="shop" class="select" style="width: 100%">
                            ...
                            <option value="{{$shop->id}}" @if($document->shop_id == $shop->id) selected @endif>{{$shop->shop_name}}</option>
                            @endforeach
                        </select>
                        @error('shop')
                                <span class="text-danger">{{$message}}</span>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="status" class="select" class="select" style="width: 100%">
                            <option value="1" @if($document->status==1) selected @endif> Sử dụng</option>
                            <option value="0" @if($document->status==0) selected @endif> Ngừng sử dụng</option>
                        </select>
                    </div>
                </div>
