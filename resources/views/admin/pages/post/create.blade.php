        ...
        <div class="card card-info">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea name="short_description" id="short-desciption" class="form-control">{!!old('short_description')!!}</textarea>
                    ...
                    <div class="card-body">
                        <div class="mb-10">
                            <a id="lfm1" data-input="thumbnail1" data-preview="holder1" class="btn image-header-wrapper">
                                <img class="header-image" id="holder1" id="favicon" src="{{old('avatar') ?? asset('images/placeholder-image.png')}}" alt="" sizes="" srcset="">
                            </a>
                            <input id="thumbnail1" type="hidden" name="avatar" class="form-control"  value="{{old('avatar')}}">
                            @error('avatar')
                                <span class="text-danger">{{$message}}</span>
                            @enderror
