...
@endsection
@section('title')
Thay đổi thông tin cơ sở kinh doanh
@endsection
@section('content')
    ...
    <div class="col-md-9">
        ...
        <div class="card card-info">
            ...
            <div class="card-header">
                <h3 class="card-title">Thay đổi thông tin cơ sở kinh doanh</h3>
            </div>
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                            <div class="t-p">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="email" name="email" id="email" placeholder="email" value="{{$shop->email ?? ''}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="username" id="username" placeholder="Tên đăng nhập" value="{{$shop->username ?? ''}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="status" class="select" style="width: 100%">
                                            <option value="1" @if ($shop->status==1 ) selected @endif>Đang kinh doanh</option>
                                            <option value="2" @if ($shop->status==2 ) selected @endif>Ngừng kinh doanh</option>
                                        </select>
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                            <div class="t-p">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="shop_name" id="shop-name" placeholder="Tên cơ sở sản xuất kinh doanh" value="{{$shop->shop_name ?? ''}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="shop_type" class="select" style="width: 100%">
                                            <option value="1" @if($shop->shop_type == 1) selected @endif>Công ty</option>
                                            <option value="2" @if($shop->shop_type == 2) selected @endif>Cá nhân</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="address" id="address" placeholder="Thôn, xóm, tên đường, số nhà" value="{{$shop->address ?? ''}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="phone" id="phone" placeholder="Điện thoại" value="{{$shop->phone ?? ''}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="career" class="select" style="width: 100%">
                                            <option></option>
                                            <option value="1" @if($shop->nganhql == 1) selected @endif>Y tế</option>
                                            <option value="2" @if($shop->nganhql == 2) selected @endif>Nông nghiệp và phát triển nông thôn</option>
                                            <option value="3" @if($shop->nganhql == 3) selected @endif>Công thương</option>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="document_type" class="select" style="width: 100%">
                                            <option></option>
                                            <option value="1" @if($shop->nganhql == 1) selected @endif> Giấy cam kết sản xuất TPAT </option>
                                            <option value="2" @if($shop->nganhql == 2) selected @endif> Giấy chứng nhận cơ sở đủ ĐK ATTP </option>
                                            <option value="3" @if($shop->nganhql == 3) selected @endif> Giấy xác nhận nguồn gốc xuất xứ </option>
                                            <option value="4" @if($shop->nganhql == 4) selected @endif> Giấy phép đăng ký kinh doanh </option>
                                            <option value="5" @if($shop->nganhql == 5) selected @endif> CMND / Thẻ căn cước </option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="document_number" id="document_number" placeholder="Số giấy tờ" value="{{$shop->document_number ?? ''}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="organ" id="organ" placeholder="Cơ quan cấp phép" value="{{$shop->document_place ?? ''}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="document_date" id="document-date" placeholder="Ngày cấp" value="{{$shop->document_date ?? ''}}" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="person" id="person" placeholder="Người Đại diện" value="{{$shop->nguoidaidien ?? ''}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="scale" class="select" style="width: 100%">
                                            ...
                                            <option value="1" @if($shop->quymo == 1) selected @endif> Cá nhân, hộ gia đình </option>
                                            <option value="2" @if($shop->quymo == 2) selected @endif> Trang trại, xưởng </option>
                                            <option value="3" @if($shop->quymo == 3) selected @endif> Hợp tác xã </option>
                                            <option value="4" @if($shop->quymo == 4) selected @endif> Doanh nghiệp siêu nhỏ </option>
                                            <option value="5" @if($shop->quymo == 5) selected @endif> Doanh nghiệp nhỏ </option>
                                            <option value="6" @if($shop->quymo == 6) selected @endif> Doanh nghiệp vừa </option>
                                            <option value="7" @if($shop->quymo ==71) selected @endif> Doanh nghiệp lớn </option>
                                        </select>
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                            <div class="t-p">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="wesite" id="wesite" placeholder="website" value="{{$shop->website ?? ''}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="fanpage" class="col-sm-2">Fanpage</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="fanpage" id="fanpage" placeholder="fanpage" value="{{$shop->fanpage ?? ''}}">
                                    </div>
                                </div>
                            </div>
                        </div>
