...
@section('title')
    Có lỗi trong quá trình thanh toán
@endsection

@section('content')
    <h1 class="text-uppercase text-center thank-text">Error!</h1>
<div class="container d-flex justify-content-center">
    ...
    <h5 class="text-center"><i>Có lỗi trong quá trình thanh toán. xin vui lòng thử lại sau</i></h5>
@endsection
